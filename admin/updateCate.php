    ...
    <div class="container">
        ...
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="title" value="<?php echo  $getCate[0]['categary'] ?>" name="sp-cate" required>
                <input type="hidden" id="title" name="idCate" required>
            </div>
            <!-- Submit Button -->
